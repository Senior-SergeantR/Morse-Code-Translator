...
public class MorseCodeController {
    ...
    //this may, we can easily look up the morse code for any given letter by using the letter by using the letter as the key

    //here i am declaring a hashmap to have a key
    ...
    public  void playSound(String[] morseMessage) throws LineUnavailableException, InterruptedException {
        //audio format specifies the audio properties that is the type of sound we want
        ...
        // duration of the sound to be played (messed with the values to get it close enough)
        int dotDuration = 200;
    ...
    private void playBeep(SourceDataLine line,int duration){
        ...
        for (int i=0; i<data.length; i++){
            ...
            //calculate the amplitude of the sine wave at the current angle and scale it to fit within the range of
            ...
            //can represent both positive and negative amplitudes
